          ...
          <div className="lg:col-span-6 flex flex-col text-left">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-8">
              <div className="flex items-start gap-3 group/feat">
                <div className="w-8 h-8 rounded-full bg-[#195641]/10 flex items-center justify-center text-[#5c7886] shrink-0 group-hover/feat:bg-[#5c7886] group-hover/feat:text-white transition-all duration-300">
