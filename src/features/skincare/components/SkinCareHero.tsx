...
export default function SkinCareHero({ onExploreClick, onKitsClick }: SkinCareHeroProps) {
  return (
    <section className="relative py-5 sm:py-10 bg-[#FAFAFA] border-b border-zinc-200/80 overflow-hidden select-none">
      ...
      {/* Subtle Pattern Grid */}
      <div className="absolute inset-0 bg-[radial-gradient(#CBD5E1_1px,transparent_1px)] bg-size-[28px_28px] opacity-30 pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
          ...
          <div className="lg:col-span-6 space-y-6 text-left">
            ...
            <div
              className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-linear-to-r from-rose-50 via-pink-50/80 to-rose-100/60 border border-rose-200/90 text-rose-800 text-xs font-bold uppercase tracking-widest shadow-2xs backdrop-blur-xs"
            ...
            {/* Grand Headline with Animated Shimmer Gradient */}
            <h1 className="font-serif text-4xl sm:text-5xl lg:text-6xl text-slate-900 leading-[1.08] tracking-tight font-normal">
              Awaken Your Skin’s{' '}
              <span className="font-bold text-green-800 block mt-1">
                Living Glass Skin{' '}
                <span
                  className="italic font-bold bg-linear-to-r from-rose-600 via-rose-500 to-rose-400 bg-clip-text text-transparent inline-block"
                  style={{
            ...
            {/* Refined Subline */}
            <p className="text-slate-900 text-base sm:text-md font-light leading-relaxed max-w-xl">
            ...
            <div className="flex flex-wrap items-center gap-4 pt-3">
              ...
              <a
                ...
                onClick={onKitsClick}
                className="px-7 py-3 rounded-full bg-white hover:bg-rose-50/50 text-slate-800 hover:text-slate-950 border border-slate-300/80 hover:border-rose-300 text-xs font-bold uppercase tracking-[0.18em] transition-all duration-300 shadow-xs hover:shadow-sm hover:-translate-y-0.5 cursor-pointer"
              >
          ...
          <div className="lg:col-span-6 relative flex items-center justify-center py-4">
            <div className="relative w-full max-w-lg mx-auto flex items-center justify-center min-h-[440px] sm:min-h-[500px]">

              {/* 1. Ambient Ruby/Rose Glowing Halo */}
              <div className="absolute w-80 h-80 sm:w-96 sm:h-96 rounded-full bg-radial from-rose-400/25 via-rose-200/20 to-transparent blur-3xl pointer-events-none" />
              ...
              <div
                className="absolute w-64 h-64 sm:w-80 sm:h-80 rounded-full bg-linear-to-b from-rose-100/70 via-white/80 to-rose-200/60 border border-white shadow-[0_20px_50px_-10px_rgba(225,29,72,0.18)] backdrop-blur-xs pointer-events-none"
                style={{ animation: 'auraBreath 6s ease-in-out infinite' }}
              />

              {/* 4. Twinkling Crystal Light Sparkles around the splash perimeter */}
              <div
                className="absolute top-8 right-12 w-2.5 h-2.5 rounded-full bg-rose-400 shadow-[0_0_12px_#F43F5E] pointer-events-none"
                style={{ animation: 'sparkleTwinkle 3s ease-in-out infinite' }}
              />
              <div
                className="absolute top-24 left-10 w-2 h-2 rounded-full bg-rose-300 shadow-[0_0_10px_#FDA4AF] pointer-events-none"
              ...
              />
              <div
                className="absolute bottom-12 left-14 w-2 h-2 rounded-full bg-rose-300 shadow-[0_0_10px_#FDA4AF] pointer-events-none"
