...
const JOURNEY_STEPS: JourneyStep[] = [
  {
    ...
    bgGradient: 'from-[#D8D9D7] to-[#A5A686]/30',
    iconSvg: (
  ...
  },
  {
    ...
    bgGradient: 'from-[#5A7A63]/5 to-[#fffef8]',
    iconSvg: (
      <svg className="w-6 h-6 stroke-current" fill="none" viewBox="0 0 24 24" strokeWidth="1.5">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-4">
        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between mb-16 gap-4">
          <div className="text-left">
            <span className="text-xs font-bold tracking-widest text-[#6F8C51] uppercase">From Seed to Serum</span>
            <h2 className="font-serif text-4xl sm:text-5xl font-normal text-[#6F8C51] mt-2 leading-tight uppercase">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-start">
              ...
              return (
                <div
                  ...
                  className={`group relative flex items-center gap-6 p-6 rounded-xl border transition-all duration-500 cursor-pointer select-none ${
                    isActive
                      ? 'bg-white border-[#6F8C51] shadow-md translate-x-2'
                ...
                >
                  ...
                  <span className={`font-serif text-3xl font-light transition-colors duration-300 ${
                    isActive ? 'text-[#6F8C51]' : 'text-gray-400 group-hover:text-brand-dark'
                  }`}>
                    {step.number}
                  </span>
                  ...
                  <div className={`w-12 h-12 rounded-full flex items-center justify-center transition-all duration-500 ${
                    isActive 
                      ? 'bg-[#6F8C51] text-white rotate-185 scale-110 shadow-sm' 
                  ...
                  <div className="text-left flex-1 min-w-0">
                    <h3 className={`font-sans text-base font-bold transition-colors duration-300 ${
                      isActive ? 'text-[#6F8C51]' : 'text-brand-dark'
                    }`}>
                      {step.title}
                    </h3>
                  ...
                  <div className={`transition-all duration-300 ${
                    ...
                    <svg className="w-5 h-5 text-[#5A7A63]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2.5">
          ...
          <div className="lg:col-span-6 h-full">
            ...
            >
              <div>
                <span className="text-[10px] font-extrabold tracking-widest text-[#6F8C51] bg-[#D8D9D7] px-3 py-1 rounded-full uppercase">
                  Step {activeStep.number} details
                </span>
                
                <h3 className="font-serif text-3xl font-normal text-[#6F8C51] mt-6 mb-2 leading-snug">
                  {activeStep.title}
                </h3>
                
                <span className="text-[11px] font-bold tracking-widest text-[#6F8C51] uppercase block mb-6">
                  {activeStep.subtitle}
                </span>
