...
export default function BestSellersFAQ() {
  ...
  return (
    <section className="relative py-14 sm:py-8 lg:py-14 bg-[#F4F8F5] border-b border-[#13442C]/10 overflow-hidden">
      <style>{`
        @keyframes faqFloat1 {
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-5 sm:mb-18">
          ...
          <p className="mt-3 text-sm sm:text-base text-gray-600 font-light max-w-4xl mx-auto leading-relaxed">
            Everything you need to know about our biological formulation
            standards, clinical efficacy, and application rituals.
          </p>
        </div>
        ...
        <div className="space-y-4">
          {filteredFaqs.map((faq, idx) => {
            ...
            return (
              <div
                key={faq.id}
                className={`rounded-md transition-all duration-400 overflow-hidden relative ${
                  isOpen
                    ? "bg-white border-1 border-[#0B1A28] border-t-2 border-t-[#A68A56] shadow-md -translate-y-0.5"
                    : "bg-white border-2 border-stone-200 hover:border-[#A68A56]/60 shadow-xs hover:-translate-y-0.5"
                }`}
              >
                <div
                ...
                >
                  ...
                  <span
                    className={`w-8 h-8 rounded-full flex items-center justify-center shrink-0 transition-all duration-400 ease-out border ${
                      isOpen
                    ...
                    <div className="px-6 pb-6 pt-3.5 border-t border-stone-100 bg-white space-y-3.5">
                      ...
                      {faq.tip && (
                        <div className="bg-[#F4F8F5] border-l-4 border-[#12602F] text-[#0B1A28] p-3.5 rounded-r-md text-xs flex items-start gap-2.5 shadow-2xs">
                          <span className="text-[#12602F] font-bold text-sm shrink-0 leading-none mt-0.5">
                            ✦
                          </span>
                          <span className="leading-relaxed">
                            <strong className="font-semibold text-[#12602F]">
                              Ritual Tip:
                            </strong>{" "}
                            {faq.tip}
                          </span>
