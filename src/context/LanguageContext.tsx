...
const TRANSLATIONS: Record<LanguageCode, Record<string, string>> = {
  en: {
    ...
    prod_1_desc: 'High-potency botanical serum infused with active plant peptides for instant luminosity and deep cellular renewal.',
    prod_2_name: 'Centella Calming Gel Cream',
    prod_2_desc: 'Ultra-nourishing lipid-replenishing moisturizer that restores epidermal strength and locks in 24h hydration.',
    prod_3_name: 'Bakuchiol Wrinkle Defense Cream',
    prod_3_desc: 'pH-balanced purifying botanical cleanser that lifts impurities without stripping essential moisture.',
    prod_4_name: 'Niacinamide Pore Refiner',
    prod_4_desc: 'Multi-molecular hyaluronic acid formula delivering multi-depth moisture surge and bouncy smoothness.',
    prod_5_name: 'Ceramide Barrier Repair Cream',
    prod_5_desc: 'Clinical-grade 10% Niacinamide + Zinc PCA to refine enlarged pores, regulate sebum, and even skin tone.',
    prod_6_name: 'Salicylic Acid Exfoliating Cleanser',
    prod_6_desc: 'Advanced encapsulated retinol treatment that reduces fine lines and triggers natural cellular turnover.',
    prod_7_name: 'Peptide Complex Firming Serum',
    prod_7_desc: 'Lightweight soothing emulsion with Asiaticoside and Madecassoside to quickly relieve irritation and redness.',
    prod_8_name: 'Squalane Cleansing Oil',
    prod_8_desc: 'Plant-derived retinol alternative that refines skin texture, improves elasticity, and smooths wrinkles.',
    prod_9_name: 'Vitamin E Hydrating Mask',
    prod_9_desc: '2% BHA botanical clarifying tonic clearing clogged pores, blackheads, and uneven skin surface.',
    prod_10_name: 'AHA/BHA Resurfacing Liquid',
    prod_10_desc: 'Triple-ceramide quenching gel that locks in hydration and reinforces natural moisture retention.',
    prod_11_name: 'Peptide Collagen Boost Fluid',
    prod_11_desc: 'Multi-peptide firming fluid stimulating pro-collagen synthesis and restoring skin bounce.',
    prod_12_name: 'Vitamin E Overnight Recovery Mask',
    prod_12_desc: 'Velvety sleep-in mask infused with Vitamin E, jojoba, and rosehip to restore depleted skin overnight.',
    prod_13_name: 'Botanical Scalp & Hair Density Serum',
    prod_13_desc: 'Targeted root-energizing serum supporting thicker, fuller, and resilient hair density.',
  ...
  hi: {
    ...
    prod_1_desc: 'सक्रिय पादप पेप्टाइड्स से युक्त उच्च प्रभावकारी वानस्पतिक सीरम जो त्वचा को तुरंत चमक और गहराई से पोषण प्रदान करता है।',
    prod_2_name: 'सेंटेला कामिंग जेल क्रीम',
    prod_2_desc: 'अल्ट्रा-पौष्टिक लिपिड-पुनर्स्थापक मॉइस्चराइज़र जो त्वचा के सुरक्षा कवच को मजबूत करता है और 24 घंटे नमी बनाए रखता है।',
    prod_3_name: 'बाकुचिओल रिंकल डिफेंस क्रीम',
    prod_3_desc: 'पीएच-संतुलित वानस्पतिक क्लींजर जो त्वचा की आवश्यक नमी को छीने बिना अशुद्धियों को धीरे से साफ करता है।',
    prod_4_name: 'नियासिनामाइड पोर रिफाइनर',
    prod_4_desc: 'मल्टी-मॉलिक्यूलर हयालूरोनिक एसिड फॉर्मूला जो त्वचा की गहरी परतों में नमी पहुंचाकर उसे कोमल और लचीला बनाता है।',
    prod_5_name: 'सिरेमाइड बैरियर रिपेयर क्रीम',
    prod_5_desc: 'क्लिनिकल-ग्रेड 10% नियासिनामाइड + जिंक पीसीए बढ़े हुए रोमछिद्रों को कसने और त्वचा की रंगत को एकसमान करने के लिए।',
    prod_6_name: 'सैलिसिलिक एसिड एक्सफ़ोलीएटिंग क्लींजर',
    prod_6_desc: 'उन्नत एनकैप्सुलेटेड रेटिनोल उपचार जो महीन रेखाओं को कम करता है और त्वचा के प्राकृतिक नवीनीकरण को बढ़ावा देता है।',
    prod_7_name: 'पेप्टाइड कॉम्प्लेक्स फर्मिंग सीरम',
    prod_7_desc: 'एशियाटिकोसाइड और मैडेकासोसाइड युक्त हल्का सुखदायक इमल्शन जो जलन और लालिमा को तेजी से शांत करता है।',
    prod_8_name: 'स्क्वालेन क्लींजिंग ऑयल',
    prod_8_desc: 'पौधों से प्राप्त प्राकृतिक रेटिनोल विकल्प जो त्वचा की बनावट में सुधार करता है और झुर्रियों को कम करता है।',
    prod_9_name: 'विटामिन ई हाइड्रेटिंग मास्क',
    prod_9_desc: '2% बीएचए वानस्पतिक क्लेरिफाइंग टॉनिक जो बंद रोमछिद्रों, ब्लैकहेड्स और असमान त्वचा को साफ करता है।',
    prod_10_name: 'एएचए/बीएचए रिसर्फेसिंग लिक्विड',
    prod_10_desc: 'ट्रिपल-सिरेमाइड जेल जो नमी को गहराई से लॉक करता है और त्वचा की सुरक्षा परत को मजबूत करता है।',
    prod_11_name: 'पेप्टाइड कोलेजन बूस्ट फ्लूइड',
    prod_11_desc: 'मल्टी-पेप्टाइड फर्मिंग फ्लूइड जो प्रो-कोलेजन निर्माण को उत्तेजित करता है और त्वचा के लचीलेपन को बहाल करता है।',
    prod_12_name: 'विटामिन ई ओवरनाइट रिकवरी मास्क',
    prod_12_desc: 'विटामिन ई, जोजोबा और रोजहिप युक्त मखमली नाइट मास्क जो रात भर में थकी त्वचा को पुनर्जीवित करता है।',
    prod_13_name: 'बॉटनिकल स्कैल्प और हेयर डेंसिटी सीरम',
    prod_13_desc: 'जड़ों को ऊर्जावान बनाने वाला लक्षित सीरम जो घने, भरे और मजबूत बालों के विकास का समर्थन करता है।',
    prod_101_name: 'स्क्वालेन रेडिएंस Glow सीरम',
  ...
  gu: {
    ...
    prod_1_desc: 'સક્રિય પ્લાન્ટ પેપ્ટાઈડ્સ સાથે તૈયાર કરાયેલ હાઈ-પોટેન્સી બોટનિકલ સીરમ જે ત્વચાને ચમક અને ઊંડું પોષણ આપે છે.',
    prod_2_name: 'સેન્ટેલા કામિંગ જેલ ક્રીમ',
    prod_2_desc: 'અલ્ટ્રા-નરિશિંગ લિપિડ-રિપ્લેનિશિંગ મોઇશ્ચરાઇઝર જે ત્વચાના બેરિયરને મજબૂત બનાવે છે અને ૨૪ કલાક હાઇડ્રેશન જાળવે છે.',
    prod_3_name: 'બાકુચિઓલ રિંકલ ડિફેન્સ ક્રીમ',
    prod_3_desc: 'પીએચ-સંતુલિત બોટનિકલ ક્લીન્ઝર જે કુદરતી ભેજ છીનવી લીધા વિના અશુદ્ધિઓને હળવાશથી દૂર કરે છે.',
    prod_4_name: 'નિયાસિનામાઇડ પોર રિફાઇનર',
    prod_4_desc: 'મલ્ટિ-મોલેક્યુલર હાયલ્યુરોનિક એસિડ ફોર્મ્યુલા જે ત્વચાના ઊંડા સ્તરોમાં ભેજ પહોંચાડીને તેને મુલાયમ રાખે છે.',
    prod_5_name: 'સિરેમાઇડ બેરિયર રિપેર ક્રીમ',
    prod_5_desc: 'ક્લિનિકલ-ગ્રેડ ૧૦% નિયાસિનામાઇડ + ઝિંક પીસીએ છિદ્રોને સુધારવા અને ત્વચાના રંગને એકસમાન કરવા માટે.',
    prod_6_name: 'સેલિસિલિક એસિડ એક્સફોલિએટિંગ ક્લીન્ઝર',
    prod_6_desc: 'અદ્યતન એન્કેપ્સ્યુલેટેડ રેટિનોલ સારવાર જે ફાઈન લાઇન્સ ઘટાડે છે અને કુદરતી સેલ્યુલર રિન્યુઅલ વધારે છે.',
    prod_7_name: 'પેપ્ટાઇડ કોમ્પ્લેક્સ ફર્મિંગ સીરમ',
    prod_7_desc: 'એશિયાટિકોસાઇડ અને મેડેકાસોસાઇડ સાથે હળવું સુખદાયક ઇમલ્સન જે બળતરા અને લાલાશને ઝડપથી શાંત કરે છે.',
    prod_8_name: 'સ્ક્વાલેન ક્લીન્સિંગ ઓઇલ',
    prod_8_desc: 'છોડમાંથી મેળવેલ રેટિનોલ વિકલ્પ જે ત્વચાના ટેક્સચરમાં સુધારો કરે છે અને કરચલીઓને સરળ બનાવે છે.',
    prod_9_name: 'વિટામિન ઇ હાઇડ્રેટિંગ માસ્ક',
    prod_9_desc: '૨% બીએચએ બોટનિકલ સ્પષ્ટતા આપતું ટોનિક જે ભરાયેલા છિદ્રો અને બ્લેકહેડ્સને સાફ કરે છે.',
    prod_10_name: 'AHA/BHA રિસર્ફેસિંગ લિક્વિડ',
    prod_10_desc: 'ટ્રિપલ-સિરેમાઇડ જેલ જે હાઇડ્રેશનને ઊંડે સુધી લોક કરે છે અને કુદરતી ભેજ જાળવણીને મજબૂત બનાવે છે.',
    prod_11_name: 'પેપ્ટાઇડ કોલેજન બૂસ્ટ ફ્લુઇડ',
    prod_11_desc: 'મલ્ટિ-પેપ્ટાઇડ ફર્મિંગ ફ્લુઇડ જે પ્રો-કોલેજન સંશ્લેષણને ઉત્તેજિત કરે છે અને ત્વચાની સ્થિતિસ્થાપકતા પુનઃસ્થાપિત કરે છે.',
    prod_12_name: 'વિટામિન ઇ ઓવરનાઇટ રિકવરી માસ્ક',
    prod_12_desc: 'વિટામિન ઇ, જોજોબા અને રોઝહિપ સાથે મખમલી નાઇટ માસ્ક જે રાતોરાત ત્વચાને તાજગી આપે છે.',
    prod_13_name: 'બોટનિકલ સ્કેલ્પ અને હેર ડેન્સિટી સીરમ',
    prod_13_desc: 'મૂળને ઉર્જાવાન બનાવતું લક્ષિત સીરમ જે જાડા, ભરેલા અને મજબૂત વાળના વિકાસમાં મદદ કરે છે.',
